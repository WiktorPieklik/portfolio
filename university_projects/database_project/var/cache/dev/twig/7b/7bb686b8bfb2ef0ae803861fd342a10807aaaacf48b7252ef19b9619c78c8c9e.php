...
class __TwigTemplate_ca07cd5dffaebf6fd2619a6451f55ac82a839e4ea2cbebf6e40aa402549b3fd3 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<form method=\"post\">
    ...
    {% if app.user %}
        <div class=\"mb-3\">
            Jesteś zalogowany/a jako {{ app.user.username }}, <a href=\"{{ path('app_logout') }}\">Wyloguj się</a>
        </div>
    {% endif %}
...
{% endblock %}
", "security/login.html.twig", "/Users/wiktorpieklik/bd2/templates/security/login.html.twig");
    }
}
